...
namespace AutorepairShopView
{
    public partial class FormReportOrders : Form
    {
        ...
        public FormReportOrders(IReportLogic logic)
        {
            ...
            reportViewer.LocalReport.LoadReportDefinition(new FileStream("C:\\Users\\Амина Закирова\\Desktop\\тп\\lab4_base\\AutorepairShopView\\ReportOrder.rdlc", FileMode.Open));
            Controls.Clear();
