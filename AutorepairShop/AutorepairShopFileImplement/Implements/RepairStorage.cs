    ...
    public class RepairStorage: IRepairStorage
    {
        ...
        private RepairViewModel CreateModel(Repair repair)
        {
            return new RepairViewModel
            {
                ...
                Price = repair.Price,
                RepairComponents = repair.RepairComponents.ToDictionary(recPC => recPC.Key, recPC => (source.Components.FirstOrDefault(recC => recC.Id == recPC.Key)?.ComponentName, recPC.Value))
            };
        }
    }
}
