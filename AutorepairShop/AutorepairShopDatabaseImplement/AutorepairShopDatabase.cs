...
namespace AutorepairShopDatabaseImplement
{
    public class AutorepairShopDatabase : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\mssqllocaldb;Initial Catalog=AutorepairShopDatabase5;Integrated Security=True;MultipleActiveResultSets=True;");
            }
